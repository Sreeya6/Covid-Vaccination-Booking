...
def main():
    ...
    filename = 'vaccination-details.json'
    mobile = None
    ...
    try:
        ...
        if os.path.exists(filename):
            ...
            try_file = input("Would you like to get the details and confirm to proceed? (y/n Default y): ")
            ...
            if try_file == 'y':
                ...
                file_acceptable = input("\nWould you like to proceed with the above information? (y/n Default n): ")
        ...
        while token_valid:
            ...
            if beneficiaries_list.status_code == 200:
                ...
                print('Your entered token is INVALID.')
                token_valid = False
