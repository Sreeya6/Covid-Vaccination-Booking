...
def collect_user_details(request_header):
    # Get Beneficiaries
    print("Fetching all the registered beneficiaries.. ")
    ...
    print("===== BE CAREFUL WITH THIS OPTION YOU CHOOSE`a! AUTO-BOOKING WILL BOOK THE FIRST AVAILABLE CENTRE, DATE, AND A RANDOM SLOT! =====")
    ...
    try:
        ...
        if len(tmp_options) > 0:
            ...
            if auto_book == 'yes-please':
                print("AUTO-BOOKING IS ENABLED. PROCEEDING WITH THE FIRST CENTRE, DATE, and RANDOM SLOT.")
                option = options[0]
...
def get_pincodes():
    locations = []
    pincodes = input("Enter few comma separated pincodes to monitor: ")
...
def get_beneficiaries(request_header):
    ...
    if beneficiaries.status_code == 200:
        ...
        print('Unable to fetch the beneficiaries')
            ...
            if txnId.status_code == 200:
                ...
                if OTP:
                    ...
                    if token.status_code == 200:
                        ...
                        print('Unable to Validate the entered OTP')
                ...
                print('Unable to Generate the OTP')
